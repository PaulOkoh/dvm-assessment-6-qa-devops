...
const drawFive = () => {
    axios.get('http://ec2-3-145-135-224.us-east-2.compute.amazonaws.com/api/robots/five')    //http://localhost:4000
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://ec2-3-145-135-224.us-east-2.compute.amazonaws.com/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://ec2-3-145-135-224.us-east-2.compute.amazonaws.com/api/player')
...
const getAllBots = () => {
    axios.get('http://ec2-3-145-135-224.us-east-2.compute.amazonaws.com/api/robots')
        .then(({data}) => {
